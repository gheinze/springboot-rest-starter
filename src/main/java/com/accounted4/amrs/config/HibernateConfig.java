...
import com.accounted4.amrs.AssetManagerRsApplication;
...
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan(AssetManagerRsApplication.class.getPackage().getName());
        ...
        jpaProperties.put("hibernate.physical_naming_strategy", "com.accounted4.amrs.config.HibernateLegacyImprovedNamingStrategy");
